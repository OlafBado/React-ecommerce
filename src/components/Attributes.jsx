                    ...
                    {(attribute.type === 'text' ? (<div className={this.props.place === 'cart' ? 'text-cart' : 'text-details'}>{attribute.items.map((item, index) => {
                        return(
                            <button
                                ...
                                value={item.value}
                                key={index} 
                                onClick={this.props.variantChange ? (e) => this.props.variantChange(e) : null} 
                                className={this.ifExists(attribute.id, item.value) ? `text-button-${this.props.place} activeText` : `text-button-${this.props.place}`}
                            >
                                {item.value}
                            </button>
                        )
                        ...
                        return(
                            <button
                                ...
                                name={attribute.id}
                                value={item.value}
                                className={this.ifExists(attribute.id, item.value) ? `swatch-button-${this.props.place} activeSwatch` :`swatch-button-${this.props.place}`}
                                onClick={this.props.variantChange ? (e) => this.props.variantChange(e) : null}
